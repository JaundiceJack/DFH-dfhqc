...
const Nav = () => {
  ...
  return (
    <nav>
      {/* Clear the nav for a printable page if looking at a certificate */}
      {!location.pathname.startsWith("/certificate") && !location.pathname.startsWith("/labels") && !location.pathname.startsWith('/rawspec') &&
