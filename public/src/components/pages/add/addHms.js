...
const AddHms = ({vals, onEntry, onClick}) => {
  return (
    <div className="flex flex-col" >
      ...
      {vals.hm_units !== 'n/a' &&
        <div className="flex flex-col">
          <Entry label="As Max:" append={vals.hm_units} name="arsenic" value={vals.arsenic}
            onChange={onEntry}/>
          <Entry label="Cd Max:" append={vals.hm_units} name="cadmium" value={vals.cadmium}
            onChange={onEntry} />
          <Entry label="Pb Max:" append={vals.hm_units} name="lead" value={vals.lead}
            onChange={onEntry} />
          <Entry label="Hg Max:" append={vals.hm_units} name="mercury" value={vals.mercury}
            onChange={onEntry} />
