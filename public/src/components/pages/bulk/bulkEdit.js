  ...
  const [bulkVals, setBulkVals] = useState(
    {
      ...
      name:   selected.name,
      blendId: selected.blend._id,
      capId: selected.capsule._id,
      dosage_type: selected.dosage_type,
      serving_units: selected.serving_units,
      batch_size: selected.batch_size,
      fill_weight: selected.fill_weight,
      capsule_weight: selected.capsule_weight,
      net_weight: selected.net_weight,
      caps_per_batch: selected.caps_per_batch,
      caps_per_serving: selected.caps_per_serving,
      caps_per_bottle: selected.caps_per_bottle,
    }
  );
